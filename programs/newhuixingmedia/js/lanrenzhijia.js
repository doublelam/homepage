...
(function(){
	function newsBubble(){
		var aDiv=document.getElementsByClassName('hover-alternate');
		for (var i = 0; i <aDiv.length; i++) {
			aDiv[i].index=i;
			aDiv[i].onclick=function(){
				$('.news-display-image')[0].src='images/news/img'+this.index+'.jpg'; 
				$('.mask').css('display','block');
				$('.newsDivImage').css('display','block'); 
				console.log('ss');  
			}
