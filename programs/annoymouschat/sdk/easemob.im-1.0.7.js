...
connection.prototype.init = function(options) {
    if (window.WebSocket&&'flex' in document.documentElement.style&&'borderRadius' in document.documentElement.style&&'transform' in document.documentElement.style&&false) {
        console.log('window.WebSocket');
        alert('window.WebSocket');
        alert('flex' in document.documentElement.style&&'borderRadius' in document.documentElement.style);
        
        this.url = options.url || (options.https ? 'wss' : 'ws') + '://im-api.easemob.com/ws/';
    } else {
        console.log('window.not websocket');
        alert('window.not websocket');
